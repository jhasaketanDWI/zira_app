...
from .views import ProjectViewSet, ProjectMemberViewSet, ProjectSummaryView, ManagedTeamMembersView, AcceptProjectInvitationView
...
urlpatterns = [
    ...
    path('projects/invitations/accept/', AcceptProjectInvitationView.as_view(), name='accept-project-invitation'),
    # path('invitations/activate/', ActivateAndSetPasswordView.as_view(), name='activate-and-set-password'),
